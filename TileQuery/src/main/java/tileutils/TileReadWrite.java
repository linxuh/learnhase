...
public class TileReadWrite {
	 ...
	 * @return byte[]
	 */
	public static byte[] getLTile(Table tbName, String level, String row, String col) {
	 ...
	 * @return boolean
	 */
	public static byte[] getHTile(Table tbName, String version, String level, String row, String col) {
		String rowkey = Rowkey.getRowkey(level,
				String.valueOf(Rowkey.getRightRowNumber(Integer.parseInt(row), Integer.parseInt(level))), col);
	...
	public static void main(String[] args) throws IOException {
		// byte bytes = new ArrayList<byte[]>();
		byte[] bytes = TileReadWrite.read("D:\\1151774625383.png");
